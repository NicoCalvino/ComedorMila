...
urlpatterns = [
    ...
    path("estado_cuentas", EstadoCuentaComedorView.as_view(), name="estado_cuentas_comedor"),
    path("estado_cuenta/<int:pk>", EstadoCuentaComedorDetalleView.as_view(), name="estado_cuenta_comedor"),
